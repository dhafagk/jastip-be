...
const signToken = (id: string, email: string, role: Role, sellerId?: string): string =>
...
export const registerSeller = async (input: SellerRegisterInput) => {
  ...
  try {
    ...
    const token = signToken(user._id.toString(), user.email, 'seller', seller._id.toString())
...
export const loginUser = async (input: LoginInput) => {
  ...
  const token = signToken(user._id.toString(), user.email, user.role, user.sellerId?.toString())
